...
const suppliersData = [
  {
    title: "Fenner Dunlop",
    description:
      "Fenner Dunlop is a renowned conveyor belting company, recognized globally for its innovative solutions in material handling. With a rich history spanning decades, Fenner Dunlop pioneers advancements in conveyor technology, ensuring reliability, efficiency, and safety in industries ranging from mining and agriculture to manufacturing and logistics. Committed to excellence, Fenner Dunlop's high-quality belting products and comprehensive services empower businesses worldwide to optimize their operations and achieve sustainable success in today's dynamic market landscape.",
    img: "https://static.wixstatic.com/media/2b8fca_5452e0049b7e4d6091f2e71bd46a95e2~mv2.gif",
    id: 1,
  },
  {
    title: "Flexco",
      ...
      <div className="suppliers__container">
        {suppliersData.map((supplier) => (
          <article className="suppliers__card" key={supplier.id}>
            <span className="suppliers__number">{supplier.id}/6</span>
